<template>
  <div class="elastic-layer edit-layer">
    ...
    <div class="edit-box">
      <div class="edit-head">
        <div class="edit-btn"><span class="arrow form-close" @click="closeEditLayer()"></span>Edit News</div>
  ...
  export default {
    ...
    setup(props,{emit}) {
      ...
      const state = reactive({
        news:props.editInfo && props.editInfo.length>0 ? JSON.parse(JSON.stringify(props.editInfo)) : [{url:'',title:''}],
        //other
        link:'',
        currentItem:null,
        isUploading: false,
